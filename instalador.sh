...
if [ -d "/etc/squid3/" ]
then
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/payload.txt -O /etc/squid3/payload.txt
	echo " " >> /etc/squid3/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/sshmonitor2.sh -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
    wget https://github.com/elisilva2017/vpsinstaller/blob/master/listar -O /bin/listar
	chmod +x /bin/listar
    wget https://github.com/elisilva2017/vpsinstaller/blob/master/udp.sh -O /bin/udp
	chmod +x /bin/udp
    wget https://github.com/elisilva2017/vpsinstaller/blob/master/udpativa -O /bin/udpativa
	chmod +x /bin/udpativa
    wget https://github.com/elisilva2017/vpsinstaller/blob/master/udpverifica -O /bin/udpverica
	chmod +x /bin/udpverica
    wget https://github.com/elisilva2017/vpsinstaller/blob/master/userbackup.sh -O /bin/userbackup
...
if [ -d "/etc/squid/" ]
then
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/squid1.text -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/squid.text -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget https://github.com/elisilva2017/vpsinstaller/blob/master/payload.text -O /etc/squid/payload.txt
